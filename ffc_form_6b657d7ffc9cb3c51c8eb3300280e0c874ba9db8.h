...
#ifndef __FFC_FORM_6B657D7FFC9CB3C51C8EB3300280E0C874BA9DB8_H
#define __FFC_FORM_6B657D7FFC9CB3C51C8EB3300280E0C874BA9DB8_H
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_0()
  {
    // Do nothing
  }
...
throw std::runtime_error("// Function evaluate_basis_derivatives not generated (compiled with -fno-evaluate_basis_derivatives)");
  ...
  {
    return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_0();
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_1()
  {
    // Do nothing
  }
...
throw std::runtime_error("// Function evaluate_basis_derivatives not generated (compiled with -fno-evaluate_basis_derivatives)");
  ...
  virtual ufc::finite_element* create() const
  {
    return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_finite_element_1();
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_0: public ufc::dofmap
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_0() : ufc::dofmap()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_0()
  {
    // Do nothing
  }
  ...
  {
    return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_0();
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_1: public ufc::dofmap
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_1() : ufc::dofmap()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::dofmap* create() const
  {
    return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_dofmap_1();
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_cell_integral_0_otherwise() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_cell_integral_0_otherwise()
  {
    // Do nothing
  }
                               ...
                               int cell_orientation) const
  {
    ...
    // Number of operations to compute element tensor for following IP loop = 127872
    for (unsigned int ip = 0; ip < 36; ip++)
    {
      ...
      // Number of operations for primary indices: 3024
      for (unsigned int j = 0; j < 24; j++)
      {
        // Number of operations to compute entry: 126
        A[j] += (((((((((((K[0]*FE1_C0_D10[ip][j] + K[2]*FE1_C0_D01[ip][j]))*((K[0]*F2 + K[2]*F3)))*(-1.0) + (FE1_C0[ip][j]*F0*(-1.0) + FE1_C2[ip][j]*F1*(-1.0))) + (((K[1]*FE1_C1_D10[ip][j] + K[3]*FE1_C1_D01[ip][j]))*((K[0]*F2 + K[2]*F3)))*(-1.0)) + (((K[0]*FE1_C1_D10[ip][j] + K[2]*FE1_C1_D01[ip][j]))*((K[1]*F2 + K[3]*F3)))*(-1.0)) + (((K[1]*FE1_C2_D10[ip][j] + K[3]*FE1_C2_D01[ip][j]))*((K[1]*F2 + K[3]*F3)))*(-1.0)) + (((((K[0]*FE1_C3_D10[ip][j] + K[2]*FE1_C3_D01[ip][j]))*((K[0]*F4 + K[2]*F5)) + ((K[1]*FE1_C3_D10[ip][j] + K[3]*FE1_C3_D01[ip][j]))*((K[0]*F6 + K[2]*F7))))*(-0.01))*(-1.0)) + (((((K[0]*FE1_C3_D10[ip][j] + K[2]*FE1_C3_D01[ip][j]))*((K[1]*F6 + K[3]*F7)) + ((K[1]*FE1_C3_D10[ip][j] + K[3]*FE1_C3_D01[ip][j]))*((K[1]*F8 + K[3]*F9))))*(-0.01))*(-1.0)) + (FE1_C3[ip][j]*(((((-1.0)*F10*F10 + F0*F1))*(1.0 / ((((((K[0]*F2 + K[2]*F3))*((K[0]*F2 + K[2]*F3)) + ((K[1]*F2 + K[3]*F3))*((K[1]*F2 + K[3]*F3))) + 1.0))*(((((K[0]*F2 + K[2]*F3))*((K[0]*F2 + K[2]*F3)) + ((K[1]*F2 + K[3]*F3))*((K[1]*F2 + K[3]*F3))) + 1.0)))) + -1.0)))*(-1.0)) + FE1_C1[ip][j]*F10*2.0*(-1.0))*W36[ip]*det;
      } // end loop over 'j'
    } // end loop over 'ip'
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_1: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_1() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_1()
  {
    // Do nothing
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_2: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_2() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_2()
  {
    // Do nothing
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_3: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_3() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_3()
  {
    // Do nothing
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_4: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_4() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_4()
  {
    // Do nothing
  }
...
class ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_form_0: public ufc::form
{
public:

  /// Constructor
  ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_form_0() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_form_0()
  {
    // Do nothing
  }
  ...
  virtual const char* signature() const
  {
    return "2a340c2263ec8dd9f45af83798fac2ee153e9ff8f5d5f958467176cf258b580c733ae19fff109c49f2d82faf403fccd7fe2cb80a3e5b9cad40e4a9cbfdc82f3b";
  }
  ...
  virtual ufc::exterior_facet_integral* create_exterior_facet_integral(std::size_t subdomain_id) const
  {
    ...
    case 1:
      {
        return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_1();
        break;
      }
    case 2:
      {
        return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_2();
        break;
      }
    case 3:
      {
        return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_3();
        break;
      }
    case 4:
      {
        return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_exterior_facet_integral_0_4();
        break;
      }
    }
  ...
  {
    return new ffc_form_6b657d7ffc9cb3c51c8eb3300280e0c874ba9db8_cell_integral_0_otherwise();
  }
